...
<template>
    ...
    <AuthenticatedLayout :display-footer="true">
        <div class="mx-auto max-w-7xl py-6 md:py-8 lg:px-8">
            ...
            <section class="mb-8">
                <div
                    class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-200 transition-all ring-inset md:p-6 dark:bg-gray-900 dark:ring-gray-800"
                >
                    <div
                        class="mb-5 flex items-center gap-x-3 text-primary-600 dark:text-primary-400"
                    >
            ...
            <section>
                ...
                >
                    <div
                        class="mb-5 flex items-center gap-x-3 text-gray-900 dark:text-gray-100"
                    >
                        <UIcon
                            name="i-lucide-tags"
                    ...
                    >
                        <div
                            class="mb-4 rounded-full bg-gray-50 p-4 ring-1 ring-gray-200 dark:bg-gray-800/50 dark:ring-gray-800"
                        >
                            <UIcon
                                name="i-lucide-tag"
